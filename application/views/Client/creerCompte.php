                                        ...
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                <div class="control-label">
                                                    <span class="spacer"><span class="before"></span><span class="text"><label id="jform_spacer-lbl" class=""><strong class="red">*</strong> Champs obligatoire</label></span><span class="after"></span></span>				</div>
                                                <div class="controls">
                                                </div>
                                            </div>
                                            <div class="group-left">
                                                ...
                                                <div class="control-group">
                                                    <div class="control-label">
                                                        <label id="jform_name-lbl" for="jform_name" class="hasTooltip required" title="<strong>Nom</strong><br />Veuillez indiquer ici votre nom complet">Nom et prénom(s):<span class="star">&#160;*</span></label>				</div>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group">
                                                    <div class="control-label">
                                                        <label id="jform_email1-lbl" for="jform_email1" class="hasTooltip required" title="<strong>Adresse email</strong><br />Veuillez indiquer ici votre adresse email">Adresse e-mail:<span class="star">&#160;*</span></label>				</div>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group-center">
                                                    <div class="control-label">
                                                        <label id="jform_profile_dob-lbl" for="jform_profile_dob" class="hasTooltip" title="<strong>Date de naissance</strong><br />Sélectionnnez la date à laquelle vous etes née.">Date de Naissance:<span class=""star">&#160;*</span></label>
                                                    </div>
                                                    <div class="controls">
