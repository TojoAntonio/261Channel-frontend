            ...
            <div id="top" class="row">
                <div class="moduletable   span6"><div class="mod-menu">
                        <ul class="nav menu nav-pills">
                            ...
                            <a class="btn btn-info" href="#modal">Se connecter</a>
                            <a class="btn btn-info" href="<?php echo base_url(); ?>UserController">S'enregistrer</a>
                            <!-- <li class="item"> </li>
                            <li class="item-178"><a href="">Créer un compte</a>-->
                            <?php } else{ ?>
                            <li class="item-143"><strong><i><?php print_r($this->session->userdata('user')[0]->U_PSEUDO) ?></i></strong>
                            <li class="item-178"><a class="modalToggle" href="<?php echo base_url(); ?>UserController/disconnect">Se déconnecter</a>
                            <?php } ?>
                            </li> </ul>
