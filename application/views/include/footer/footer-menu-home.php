            ...
            <div id="footer" class="row">
                <div class="moduletable   span4"><div class="mod-menu">
                        ...
                        <?php if($this->session->userdata('user') == null){ ?>
                            <li class="item-101 active"><a href="<?php echo base_url() ?>">Home</a>
                            </li><li class="item parent"><a href="<?php echo base_url() ?>index.php/programmeDuJour/emissionsDuJour/emissions">Programme</a>
                            </li><li class="item-140"><a href="#">Recherche</a>
                            </li><li class="item-142"><a href="<?php echo base_url();?>index.php/contact">Contacts</a>
                            </li><li class="item"><a href="#modal">Login</a>
                            </li> </ul>
                        <?php } else{ ?>
                            <li class="item-101 active"><a href="<?php echo base_url() ?>">Home</a>
                            </li><li class="item parent"><a href="<?php echo base_url() ?>index.php/programmeDuJour/emissionsDuJour/emissions">Programme</a>
