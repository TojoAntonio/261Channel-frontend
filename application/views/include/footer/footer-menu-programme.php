            ...
            <div id="footer" class="row">
                <div class="moduletable   span4"><div class="mod-menu">
                        ...
                        <?php if($this->session->userdata('user') == null){ ?>
                            <li class="item-101"><a href="<?php echo base_url() ?>index.php/programmeDuJour/emissionsDuJour">Home</a>
                            </li><li class="item parent active"><a href="<?php echo base_url() ?>index.php/programmeDuJour/emissionsDuJour/emissions">Programme</a>
                            ...
                            </li><li class="item-134 parent"><a href="#modal">Login</a>
                            </li> </ul>
                        <?php } else{ ?>
                            <li class="item-101"><a href="<?php echo base_url() ?>index.php/programmeDuJour/emissionsDuJour">Home</a>
                            </li><li class="item parent active"><a href="<?php echo base_url() ?>index.php/programmeDuJour/emissionsDuJour/emissions">Programme</a>
